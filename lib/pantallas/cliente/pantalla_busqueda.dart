...
class _SearchScreenState extends State<SearchScreen>
 ...
 void initState() {
   ...
   WidgetsBinding.instance.addPostFrameCallback((_) {
     final serviceProvider = context.read<ProveedorServicio>();
 ...
 Widget _buildQuickSearchView() {
   return Consumer<ProveedorServicio>(
     builder: (context, serviceProvider, child) {
       if (serviceProvider.estaCargando) {
         return const WidgetCargando();
       }
       
       final servicios = serviceProvider.servicios;

       return Column(
         children: [
           // Estadísticas de búsqueda
           _buildSearchStats(servicios.length),
 ...
 Widget _buildServicesList(List<ModeloServicio> servicios) {
 ...
 Widget _buildServiceCard(ModeloServicio servicio) {
   return Container(
           ...
           child: Row(
             children: [
               ...
               Container(
                 ...
                 child: Icon(
                   _getCategoryIcon(servicio.categoria),
                   color: AppColors.primary,
                   size: 32,
                 ),
               ),
               ...
               Expanded(
                 child: Column(
                   ...
                   children: [
                     ...
                     Text(
                       'Proveedor: ${servicio.proveedorId}',
                       style: const TextStyle(
                         fontSize: 14,
                         color: AppColors.textSecondary,
                       ),
               ...
               Column(
                 ...
                 children: [
                   ...
                   Container(
                     ...
                     decoration: BoxDecoration(
                       color: _getServiceAvailability(servicio)
                           ? Colors.green.withValues(alpha: 0.1)
                           : Colors.red.withValues(alpha: 0.1),
                       borderRadius: BorderRadius.circular(8),
                     ),
                     child: Text(
                       _getServiceAvailability(servicio)
                           ? 'Disponible'
                           : 'Ocupado',
                       style: TextStyle(
                         fontSize: 12,
 ...
 String _getServiceLocation(ModeloServicio servicio) {
   final locations = [
     'Centro Norte',
     'La Carolina',
     'Cumbayá',
   ...
   return locations[servicio.id.hashCode % locations.length];
 }

 bool _getServiceAvailability(ModeloServicio servicio) {
   return servicio.calificacion > 3.5;
 }
