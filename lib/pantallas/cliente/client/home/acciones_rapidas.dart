        ...
        children: [
          const Text(
            ...
            style: TextStyle(
              ...
              color: AppColors.textPrimary, // ✅ CORREGIDO
            ),
          ),
    ...
    final acciones = [
      {
        ...
        'color': AppColors.primary, // ✅ CORREGIDO
        'accion': () => _navegarAServicios(context),
      },
      {
        'titulo': 'Ver mis\nreservas',
        'icono': Icons.calendar_today,
        'color': AppColors.success, // ✅ CORREGIDO
        'accion': alNavegarAReservas,
      },
      {
        'titulo': 'Buscar por\ncategoría',
        'icono': Icons.search,
        'color': AppColors.secondary, // ✅ CORREGIDO
        'accion': () => _navegarABusqueda(context),
      },
      {
        'titulo': 'Contactar\nsoporte',
        'icono': Icons.support_agent,
        'color': AppColors.warning, // ✅ CORREGIDO
        'accion': alNavegarAChat,
      },
      {
        'titulo': 'Ver\nhistorial',
        'icono': Icons.history,
        'color': AppColors.info, // ✅ CORREGIDO
        'accion': () => _mostrarHistorial(context),
      },
      {
        'titulo': 'Calificar\nservicio',
        'icono': Icons.star_rate,
        'color': AppColors.accent, // ✅ CORREGIDO
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: AppColors.surface, // ✅ CORREGIDO
            borderRadius: BorderRadius.circular(12),
            border: Border.all(color: AppColors.divider), // ✅ CORREGIDO
            boxShadow: [
              BoxShadow(
                color: AppColors.shadow, // ✅ CORREGIDO
                blurRadius: 8,
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                height: 40,
                decoration: BoxDecoration(
                  color: color.withValues(alpha: 0.1), // ✅ CORREGIDO: withValues
