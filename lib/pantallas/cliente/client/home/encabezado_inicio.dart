// nucleo/widgets/client/widget_encabezado.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import '../../../../proveedores/proveedor_autenticacion.dart'; // ✅ AuthProvider
...
class WidgetEncabezado extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Consumer<AuthProvider>( // ✅ CORREGIDO: AuthProvider
        builder: (context, authProvider, child) {
          String nombreUsuario = 'Usuario';
          if (authProvider.currentUser != null) { // ✅ CORREGIDO: currentUser
            final usuario = authProvider.currentUser!;
            if (usuario.name.isNotEmpty) { // ✅ CORREGIDO: name
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      ...
                      style: TextStyle(
                        fontSize: 16,
                        color: AppColors.textSecondary, // ✅ CORREGIDO
                      ),
                    ),
                  ],
                ),
