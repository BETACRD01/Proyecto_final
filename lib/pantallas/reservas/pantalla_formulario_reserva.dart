...
import '../../nucleo/utilidades/utilidades_fecha.dart' as utilidades_fecha_app;
            ...
            child: Row(
              children: [
               ...
               Expanded(
                 child: Text(
                   _selectedDate != null
                       ? utilidades_fecha_app.DateUtils.formatDateForDisplay(
                           _selectedDate!)
                       : 'Seleccionar fecha',
                   style: TextStyle(
                     fontSize: 16,
      ...
      children: [
        ...
        if (_selectedDate != null) ...[
          Wrap(
           ...
           runSpacing: 8,
           children:
             utilidades_fecha_app.DateUtils.getAvailableTimeSlots().map((time) {
